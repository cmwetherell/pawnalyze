...
import { getOlympiadRun, getOlympiadSummary, getOlympiadTeamDetail } from '@/lib/olympiad/queries';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const detail = await getOlympiadTeamDetail(event, run.runId, teamId, run.roundsCompleted + 1, parsed.picks);
