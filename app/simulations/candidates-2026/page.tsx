        ...
        <main className="flex-1 flex flex-col min-h-screen bg-gray-50">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 pb-2">
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-3xl">
                    Who will challenge Gukesh for the crown? We ran <strong className="text-gray-800">over one million Monte Carlo
                    simulations</strong> of the Candidates Tournament to find out. Use the <strong className="text-gray-800">Scenario
                    Builder</strong> to set game outcomes and see how the probabilities shift in real time.
                </p>
            </div>

            <SimulationResults eventTable="candidates_2026" />
                    ...
                    <div className="border-t border-gray-200 pt-8">
                        ...
                        <div className="space-y-4 text-sm text-gray-600 leading-relaxed">
                            ...
                            <p>
                                ...
                                scenarios: <em>What happens if Caruana wins his next game? What if
                                Nakamura draws?</em> The chart updates instantly to reflect your
                                custom scenario.
                            </p>
                            <p>
